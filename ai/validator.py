...
def _valider_date_ou_null(valeur):
    """
    Valide une date en utilisant dateutil.parser qui supporte de nombreux formats.
    ...
    try:
        # dayfirst=True pour interpréter correctement les dates comme 08/07/2026 (8 juillet)
        date = parser.parse(valeur, dayfirst=True)
