...
<head>
  ...
  <style>
    * {
    ...
    .completed .circle .step-number,
    .active .circle .step-number {
      opacity: 1;
    }

    /* Icon inside the circle when completed */
    .completed .circle .step-icon {
      display: none;
    }
...
<div class="timeline" id="timelineContainer">
  ...
  <div class="item" data-step="0">
    <div class="left">
      <div class="circle">
        ...
        <i class="fas fa-check step-icon" style="display: none;"></i>
      </div>
      <div class="line"></div>
    </div>
    <div class="text">
      <h3>Téléchargement</h3>
      <p>Document envoyé avec succès</p>
    </div>
  </div>
  ...
  <div class="item" data-step="2">
    ...
    <div class="text">
      <h3>Extraction</h3>
      <p>Lecture des données par IA</p>
    </div>
  </div>
  ...
  (function() {
    ...
    function updateSteps(newActiveIndex) {
      ...
      items.forEach((item, index) => {
        ...
        const stepIcon = circle.querySelector('.step-icon');
    ...
    async function checkStatus() {
      try {
        ...
        // Match the statuses from the job
        switch (data.status) {
            case "uploaded":
                updateSteps(0);
                break;
    ...
    function redirectToPage3() {
      window.location.href = "page3.php?id=<?= $invoiceId ?>";
    }

    window.redirectToPage3 = redirectToPage3;

    window.addEventListener("load", async () => {
      console.log('Page loaded, starting invoice processing...');
