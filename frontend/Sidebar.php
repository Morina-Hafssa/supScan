...
// ============================================================
// DYNAMIC ACTIVE LINK DETECTION - FIXED!
// ============================================================
...
// For pages with query parameters (like page3.php?id=xxx)
function isActiveWithParam($pageName) {
    $currentPage = basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));
    return ($currentPage === $pageName) ? 'active' : '';
}

// Alternative: Check if page is in the URL path
function isActivePath($pageName) {
    $currentPath = $_SERVER['REQUEST_URI'];
    return strpos($currentPath, $pageName) !== false ? 'active' : '';
}

// Get badge count (example: from localStorage via JavaScript)
// We'll use JavaScript to set badge counts dynamically
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <!-- Sidebar Menu -->
    <nav class="menu">
        <a href="<?= $base_url ?>page1.php" class="sidebar-brand">
            <div class="logo-container">
                <img src="<?= $base_url ?>imgs/suprajitLogo.png" alt="Suprajit Logo">
            </div>
        ...
        <ul>
            <li>
                <a href="<?= $base_url ?>page1.php" class="<?= isActive('page1.php') ?>">
                    <i class="fas fa-home"></i>
                    <span class="link-text">Accueil</span>
                </a>
            </li>
            <li>
                <a href="<?= $base_url ?>page5.php" class="<?= isActive('page5.php') ?>">
            ...
            <li>
                <a href="<?= $base_url ?>statis.php" class="<?= isActive('statis.php') ?>">
